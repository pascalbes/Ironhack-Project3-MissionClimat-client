...
const Contact = () => {
    ...
    return (
        <form className="form contact-form flex-item flex-column" onChange={handleChange} onSubmit={handleSubmit}>
            ...
            <select className="input border-btn" id="objet" name="objet" placeholder="- Choisissez" required>
            ...
            <textarea className="input border-btn" id="message" name="message" cols="30" rows="10" placeholder="Tapez ici" required></textarea>
