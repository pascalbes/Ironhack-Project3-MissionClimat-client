      ...
      <div id="scrollOptions" className=" sim-cat-params-box sticky">
        ...
        <div className="sim-options flex-item flex-column">
          <div className="sim-option-box">
            ...
            <p>
              Afin de gagner du temps, vous pouvez initialiser l'ensemble des
              données à des valeurs spécifiques
            </p>
            <form
            ...
            <p>
              Pourquoi l'étude 1,5°C de BL Evolution ne fait pas 1.5°C dans le
              simulateur ? Réponse dans notre <b>FAQ</b> (page concept)
            </p>
          </div>
          <div className="sim-option-box">
            <h6 className="param-name">Mode Expert</h6>
            <p>
              Le mode expert permet d'accéder à un plus grand nombre de
              paramètres, pour régler son scénario avec davantage de finesse
            </p>
            <FormControlLabel
