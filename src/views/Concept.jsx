    ...
    <div className="concept-page flex-item flex-column light-text">
      ...
      {selectedChapter == "concept" && (
        <div id="concept" className="concept-box border-btn flex-item flex-column">
          ...
          <p>
            ...
            réduit. Un mode expert permet néanmoins de modifier plus de paramètres, pour ceux qui le souhaitent. Le modèle de calcul est téléchargeable à la page "à propos".{" "}
          </p>
          ...
          <p>
            ...
            territoriales sont de l’ordre de 6,6 tonnes de CO2e par habitant quand l’empreinte carbone des Français, incluant l’ensemble des
          ...
          <p>
            ...
            logements à rénover, nombre de vols réalisés par an…) sont configurables par
            l’utilisateur, et impactent les émissions de gaz à effet de serre
            du secteur (indiqués par une jauge dédiée), et donc les émissions globales (visibles dans le volet de droite de la page simulateur). Un mode expert permet à l’utilisateur de modifier plus de paramètres, préremplis par défaut.
          </p>
          ...
          <p>
            Une fois les émissions françaises calculées, comment obtenir les émissions mondiales ? Avec simplement 2 paramètres. D'abord, une estimation de l’évolution de la population
      ...
      {selectedChapter == "enjeux" && (
        <div id="enjeux" className="concept-box border-btn  flex-item flex-column">
          ...
          <div className="concept-img-box flex-item">
            ...
            <a href="https://www.conventioncitoyennepourleclimat.fr/wp-content/uploads/2019/10/03102019-convcit-socledoc-web.pdf" target="_blank">
              > Autres sources
            </a>
          </div>
          ...
          <p>
            ...
            fini est un système complexe ! Dans un monde fini, c'est à dire avec des limites,
            il n'est plus possible d'accroître notre utilisation d’énergies fossiles et
            de préserver le climat auquel nous sommes habitués. Il n'est plus possible
            d'accroître notre utilisation des ressources naturelles et
          ...
          <p>
            Actuellement, on observe un changement du climat dû
          ...
          <p>
            ...
            des gaz à effet de serre de manière plus marginale, comme les
          ...
          <div className="concept-impact-box flex-item">
            ...
            <p>
              En plus de l'amplitude du changement, la
              vitesse à laquelle il se produit, sans précédent, est un facteur de déstabilisation très important. Le changement climatique actuel est 100 fois plus rapide que par le passé, menaçant de très nombreux écosystèmes.
            </p>
          </div>
          ...
          <div className="concept-impact-box flex-item">
            ...
            <p>
              La fonte des calottes polaires et des glaciers, mais surtout le réchauffement de l'océan (et ainsi de sa dilatation), va causer l'augmentation du niveau de la mer. Beaucoup de villes côtières, dont des mégalopoles, risquent de se retrouver sous 1m ou 2m d'eau. Des îles risquent tout simplement de disparaître.
            </p>
          </div>
          ...
          <div className="concept-impact-box flex-item">
            ...
            <p>
              L'acidification de l'océan, causé par les gaz à effet de
          ...
          <p>
            ...
            Chaque dixième de degré compte. Chaque année d’émission de gaz à effet de
      ...
      {selectedChapter == "qna" && (
        <div className="concept-box border-btn  flex-item flex-column question">
          ...
          <h5>
            La France ne représente que 1% des émissions mondiales, nos efforts ne sont-ils pas vains ?{" "}
          </h5>
          <p>
          ...
          <p>
            D'abord, la France est en fait responsable de près de 2% des émissions
            ...
            la France pourrait, si elle était exemplaire et par la capacité d'influence qu'elle possède, comme toute autre puissance, inspirer de nombreux pays dans son sillage. En tous cas, elle serait bien plus légitime pour négocier en ce sens.
            {" "}
          </p>
          ...
          <p>
            ...
            n'est pas du tout adaptée à cela et ne l'encourage en rien.
            C'est un mouvement d'ensemble, associant toutes les échelles et soucieux de tous,
            qui pourra permettre de répondre aux enjeux climatiques, sans oublier les autres enjeux environnementaux et, vous l'aurez compris, les enjeux sociaux.{" "}
          </p>
