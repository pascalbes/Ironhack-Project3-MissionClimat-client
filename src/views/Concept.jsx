    ...
    <div className="concept-page flex-item flex-column light-text">
      ...
      {selectedChapter == "concept" && (
        ...
        >
          ...
          <p>
            ...
            Agriculture et alimentation, Biens et services, Énergie) sont
            modélisées à partir d’hypothèses et des meilleures données
            disponibles. L’approche retenue est celle de l’
            <b>empreinte carbone</b> : elle intègre les émissions importées en
            plus des émissions ayant directement lieu sur le territoire français
            et est en ce sens bien plus juste. Ainsi, l’inventaire national
            indique que les émissions de gaz à effet de serre territoriales sont
            de l’ordre de 6,6 tonnes de CO2e par habitant quand l’empreinte
            carbone des Français, incluant l’ensemble des émissions importées
            (liées le plus souvent à la fabrication de biens de consommation à
            l’étranger) s’élève à 10,5 tonnes de CO2e par habitant.
          </p>
          ...
          <p>
            ...
            logements à rénover, nombre de vols réalisés par an…) sont
            configurables par l’utilisateur, et impactent les émissions de gaz à
            effet de serre du secteur (indiqués par une jauge dédiée), et donc
            les émissions globales (visibles dans le volet de droite de la page
            simulateur). Un mode expert permet à l’utilisateur de modifier plus
            de paramètres, préremplis par défaut.
          </p>

          <div>
            <p>
              Pour guider l’utilisateur, les informations suivantes sont
              disponibles, associées à chaque paramètre (accessibles en cliquant
              sur le " ? ") :
            </p>
            <ul>
              <li>
          ...
          <div>
            <p>
              Avec l'ensemble des paramètres configurés, les émissions
              françaises sont calculées et représentées dans le volet de droite
              avec :
            </p>
            ...
            <ul>
              <li>
                ...
                <ul>
                  <li>
                    l'évolution en pourcentage des émissions entre 2020 et 2030,
                  </li>
              ...
              <li>
                ...
                <ul>
                  <li>
                    l'évolution des émissions entre 2020 et 2030, par secteur
                  </li>
            ...
            <p>
              Ainsi, vous disposez de tous les éléments pour guider les choix de
              votre scénario.
            </p>
          </div>
          ...
          <p>
            Une fois les émissions françaises calculées, comment obtenir les
            émissions mondiales ? Avec simplement 2 paramètres. D'abord, une
            estimation de l’évolution de la population mondiale, de 8 à 9
            milliards d’individus en 2030.
          </p>

          <div>
            <p>
              Ensuite, une hypothèse sur la trajectoire des autres pays, à
              choisir parmi les 2 suivantes :
            </p>
            <ul>
              <li>
                Egalité stricte : Tous les citoyens du monde ont la même
                empreinte carbone en 2030. Le niveau d'effort dépend du point de
                départ. Les pays développés réduisent plus leur empreinte.
                Certains pays en voie de développement peuvent légèrement
                l'augmenter.
              </li>
              <li>
                "Maintien des inégalités" : Tous les citoyens baissent (ou
                augmentent) proportionnellement leur empreinte carbone d'un même
                effort. A l'arrivée, les pays développés ont toujours une
                empreinte carbone plus élevée que les pays en voie de
                développement.
              </li>
            </ul>
          </div>
      ...
      {selectedChapter == "enjeux" && (
        ...
        >
          ...
          <p>
            Nous reprenons ici du contenu rédigé par l'association Avenir
            Climatique, simplement retouché. Elle a développé une série de
            vidéos pour décrypter les enjeux énergie climat qui peuvent être un
            excellent moyen de s'y former.
          </p>
          ...
          <p>
            ...
            fini est un système complexe ! Dans un monde fini, c'est à dire avec
            des limites, il n'est plus possible d'accroître notre utilisation
            d’énergies fossiles et de préserver le climat auquel nous sommes
            habitués. Il n'est plus possible d'accroître notre utilisation des
            ressources naturelles et laisser la possibilité aux générations
            futures de les utiliser. En monde fini, on ne peut plus à la fois
            accroître notre quantité de déchets et conserver la qualité de notre
            environnement.
          </p>
          ...
          <p>
            ...
            Depuis 500 000 ans, ces variations sont relativement cycliques avec
            une alternance d’ères glaciaires qui durent 100 000 ans, avec une
            température moyenne inférieure de 5°C à l'actuelle et d’ères
            interglaciaires de 10 000 ans, comme celle dans laquelle nous nous
            trouvons.
          </p>

          <p>
            Actuellement, on observe un changement du climat dû aux émissions de
            gaz à effet de serre de l’humanité. Ces gaz amplifient l’effet de
            serre, que l’on peut comparer au couvercle de la casserole qu’on
            chauffe : il permet de retenir une plus grande quantité de chaleur
            sur Terre. On constate déjà une élévation des températures moyennes
            du globe de 1°C (et 1,5°C sur les terres) en 100 ans et on attend,
            selon le niveau d’émissions futures, une augmentation de ces
            températures de 1.5°C à 6°C sur le XXIe siècle.
          </p>

          <p>
            D'où viennent ces gaz à effet de serre ? La combustion des énergies
            fossiles et la déforestation libèrent du dioxyde de carbone (CO2)
            dans l'atmosphère. L'élevage, les rizières et les fuites de gaz
            naturel libère du méthane (CH4). L’utilisation d’engrais azotés qui
            sont dégradés par des bactéries émet du protoxyde d’azote (N2O).
            D'autres activités humaines génèrent des gaz à effet de serre de
            manière plus marginale, comme les composés fluorés CFC. Depuis 1850,
            la concentration observée des différents gaz à effet de serre a
            explosé : +40% pour le CO2 ou +280% pour le méthane !
          </p>
          ...
          <div className="concept-impact-box flex-item">
            ...
            <p>
              ...
              important. Le changement climatique actuel est 100 fois plus
              rapide que par le passé, menaçant de très nombreux écosystèmes.
            </p>
          </div>
          ...
          <div className="concept-impact-box flex-item">
            ...
            <p>
              ...
              l'augmentation du niveau de la mer. Beaucoup de villes côtières,
              dont des mégalopoles, risquent de se retrouver sous 1m ou 2m
              d'eau. Des îles risquent tout simplement de disparaître.
            </p>
          </div>
          ...
          <p>
            ...
            Chaque dixième de degré compte. Chaque année d’émission de gaz à
            effet de serre compte. Chaque tonne de CO2 compte.
          </p>
          ...
          <p>
            ...
            l’habitat, des modes d’organisation du travail à l’urbanisme, de ce
            que nous sommes aujourd'hui à ce que nous pouvons être demain. Bref,
            une vraie mission, au moins climatique, sûrement anthropologique.
          </p>
        </div>
      )}
      {selectedChapter == "qna" && (
        <div className="concept-box border-btn  flex-item flex-column question">
          ...
          <p>
            D'abord, la France est en fait responsable de près de 2% des
            émissions historiques (les émissions cumulées depuis 1850) alors
            qu'elle représente moins de 1% de la population mondiale. Ce total
            est encore plus important si on intègre les émissions non
            énergétiques (agriculture, déchets...) et les émissions importées
            (ces émissions représentent plus de 30% de l'empreinte carbone des
          ...
          <p>
            ...
            serre en France jusqu'à 2030. En l'espace de 10 ans, il est très
            improbable qu'une rupture technologique, déployée à l'échelle
            industrielle dans le monde, modifie le système actuel de manière
          ...
          <h5>
            Se fixer un objectif 1,5°C : c’est envisager un changement global de
            système ?
          </h5>
          <p>
            Notre modèle de calcul montre qu'une trajectoire 1,5°C à l'échelle
            ...
            n'est pas du tout adaptée à cela et ne l'encourage en rien. C'est un
          ...
          <p>
            En 2018, le GIEC estimait le budget carbone global restant (associé
            à une limitation du réchauffement climatique de 1,5°C) de 420 à 580
            milliards de tonnes de CO2e (les incertitudes sont liées aux
            différences de résultats des modèles utilisés). Chaque année, nous
            émettons environ 50 milliards de tonnes de CO2e. Ainsi, d'ici une
            dizaine d'années, nous aurons épuisé notre budget carbone associé à
            une trajectoire 1,5°C. Chaque année de retard dans la baisse des
            émissions nous obligerait à rattraper cet effort dans les années
            suivantes.
          </p>
        </div>
      )}
