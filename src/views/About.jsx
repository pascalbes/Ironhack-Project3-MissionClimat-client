  ...
  return (
    <div className="about-page flex-item flex-column">
      <article className="about-card about-conception border-btn  flex-item flex-column">
        ...
        <p>
          S’appuyant sur les données scientifiques contenues dans le rapport du <b>Groupe
          d’Experts Intergouvernemental sur l’Evolution du Climat (GIEC)</b> intitulé
          <i><b>«Réchauffement planétaire de 1,5°C»</b></i>, l’objectif de cette étude
          était de donner à voir l'importance des mesures concrètes permettant de réduire
          les émissions de gaz à effet de serre de la France pour s’aligner sur les recommandations
          des scientifiques du GIEC, et limiter l'impact des conséquences du réchauffement climatique
        ...
        <p>
          ...
          décident de démocratiser et valoriser ce modèle autour d'un simulateur web, dont ils
          ne savent pas encore qu'il s'appellera "Mission Transition". Une première maquette 
          ...
          En parallèle, Guillaume parfait le modèle avec l'aide de Célian Niclot.
        </p>
        <p>
          Le projet, appelé tour à tour "Mon Scénario Climat", "Mission 1.5" puis "Mission Climat",
          est finalement honoré en étant élu meilleur projets web lors des votes de la promotion
          de dev web puis du hackshow du 9 mars. Champagne! Et repos...
        </p>

        <h5>Développement Mission Transition / Avril 2020</h5>
        <p>
          Après un cours repos, et la naissance de Flore Besson, une petite équipe est
          montée pour finaliser le projet. Oriana Berthomieu définit l'UI finale du projet,
          en s'inspirant du travail déjà réalisé par Nina, et Emmanuel Bernard rejoint Pascal
          pour finaliser le développement.
        </p>
        <p>
          Le site sort enfin le 3 mai 2020, au grand bonheur de tout ce joli monde, et nous l'espérons,
          au vôtre également ! L'ensemble de l'équipe s'est investie bénévolement.
        </p>
      </article>
