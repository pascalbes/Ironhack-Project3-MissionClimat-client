            ...
            <article className="hero-landing flex-item flex-column">
                ...
                <div className="hero-box flex-item">
                    <div className="hero-left">
                        ...
                        <p className="hero-text light-text">Votre mission, si vous l'acceptez, est de proposer un scénario climat 2030 pour la France, permettant de limiter les impacts du dérèglement climatique à un niveau soutenable. Pour ce faire, nous mettons à votre disposition quelques paramètres, un modèle de calcul et un joli tableau de bord.</p>
                        <p className="hero-text bold-text">Configurez, visualisez, et, une fois l'ensemble du <br/>vivant préservé, partagez : il paraît que c'est sympa.</p>
                        <br></br>
